...
#ifndef LL_LLPanelMeta7_H
#define LL_LLPanelMeta7_H
...
class LLPanelMeta7 : public LLPanel
{
public:
	LLPanelMeta7();
	virtual ~LLPanelMeta7();
...
private:
	...
	static void callbackMeta7Stealth(const LLSD &notification, const LLSD &response);
	static void callbackMeta7NoStealth(const LLSD &notification, const LLSD &response);
